...
export default function Footer() {
    return (
        <footer className="w-full bg-[#010104] text-[#EBE9FC] py-12 px-6 mt-auto">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <Link to="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                    ...
                    <span className="text-xl font-bold tracking-wide">The Inequality Atlas</span>
                </Link>

                {/* Copyright */}
                <div className="text-sm font-medium opacity-60">
                    &copy; {new Date().getFullYear()} The Inequality Atlas. All rights reserved.
                </div>

                {/* Links */}
                <div className="flex flex-wrap justify-center items-center gap-6 text-sm font-semibold">
                    <a href="https://github.com/Minaa111/the-inequality-atlas" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors opacity-80 hover:opacity-100">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                        GitHub Repo
                    </a>
                    <a href="https://github.com/Minaa111" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors opacity-80 hover:opacity-100">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                        Developer GitHub
                    </a>
                    <a href="https://www.linkedin.com/in/minaa-aziz/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors opacity-80 hover:opacity-100">
